...
namespace Alpenstern_BackEnd_Neu.Models
{
    ...
    public partial class Raum508Entities : DbContext
    {
        public Raum508Entities()
            : base("name=Raum508Entities")
        {
        }
        ...
        [DbFunction("Raum508Entities", "get_user_salt")]
        public virtual IQueryable<get_user_salt_Result> get_user_salt(string benutzername)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<get_user_salt_Result>("[Raum508Entities].[get_user_salt](@benutzername)", benutzernameParameter);
        }
    
        [DbFunction("Raum508Entities", "login_user")]
        public virtual IQueryable<login_user_Result> login_user(string benutzername, string passwort)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<login_user_Result>("[Raum508Entities].[login_user](@benutzername, @passwort)", benutzernameParameter, passwortParameter);
        }
