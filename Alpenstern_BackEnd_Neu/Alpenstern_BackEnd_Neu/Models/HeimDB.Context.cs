...
namespace Alpenstern_BackEnd_Neu.Models
{
    ...
    public partial class alpensternEntitiesHeim : DbContext
    {
        public alpensternEntitiesHeim()
            : base("name=alpensternEntitiesHeim")
        {
        }
        ...
        [DbFunction("alpensternEntitiesHeim", "get_user_salt")]
        public virtual IQueryable<get_user_salt_Result> get_user_salt(string benutzername)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<get_user_salt_Result>("[alpensternEntitiesHeim].[get_user_salt](@benutzername)", benutzernameParameter);
        }
    
        [DbFunction("alpensternEntitiesHeim", "login_user")]
        public virtual IQueryable<login_user_Result> login_user(string benutzername, string passwort)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<login_user_Result>("[alpensternEntitiesHeim].[login_user](@benutzername, @passwort)", benutzernameParameter, passwortParameter);
        }
